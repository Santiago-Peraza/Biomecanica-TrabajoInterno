...
def energia_rot(aux, masa, n):
    ...
    for k in range(0, len(wa1_r)):
        E_bra_r.append(0.5 * m_bra * k_b ** 2 * wa2_r[k] ** 2)
        E_ant_r.append(0.5 * m_ant * k_a ** 2 * wa1_r[k] ** 2)
        E_mus_r.append(0.5 * m_mus * k_m ** 2 * wb1_r[k] ** 2)
        E_leg_r.append(0.5 * m_leg * k_l ** 2 * wb2_r[k] ** 2)
        E_foo_r.append(0.5 * m_foo * k_f ** 2 * wb3_r[k] ** 2)
    ...
    for k in range(0, len(wa1_l)):
        E_bra_l.append(0.5 * m_bra * k_b ** 2 * wa2_l[k] ** 2)
        E_ant_l.append(0.5 * m_ant * k_a ** 2 * wa1_l[k] ** 2)
        E_mus_l.append(0.5 * m_mus * k_m ** 2 * wb1_l[k] ** 2)
        E_leg_l.append(0.5 * m_leg * k_l ** 2 * wb2_l[k] ** 2)
        E_foo_l.append(0.5 * m_foo * k_f ** 2 * wb3_l[k] ** 2)
    # print(d11_l)
